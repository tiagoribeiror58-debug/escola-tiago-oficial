...
// Slugs fixados permanentemente na seção "Missão Principal" — sem ação do usuário.
export const PINNED_FOREVER: string[] = ['founder-solo-masterclass', 'gestao-conhecimento'];
